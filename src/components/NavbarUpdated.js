  ...
  return (
    <div>
      <ul class="flex flex-col">
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
        ...
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          ...
          <div class="text-[14px]">Orders</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Products</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Delivery</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Marketing</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Analytics</div>
        </li>
        <li class="bg-white bg-opacity-10 text-white flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
              stroke="currentColor"
              fill="currentColor"
          ...
          <div class="text-[14px]">Payments</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
        ...
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          ...
          <div class="text-[14px]">Discounts</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Audience</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Appearance</div>
        </li>
        <li class="text-[#D2D4D9] flex flex-row items-center my-1 px-[16px] py-[8px] hover:bg-white hover:bg-opacity-20 rounded">
          <div class="mr-1 text-[20px]">
            <svg
          ...
          <div class="text-[14px]">Plugins</div>
        </li>
      </ul>
